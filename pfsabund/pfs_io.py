...
class ReadPFSObject():
    ...
    def __init__(self):
        ...
        self.hdu_dict['fluxtbl'] = 8  #ENK 6-28-2023: changed from 8 to 9 to accommodate EDR1
    ...
    def read_fits(self, catId, tract, patch, objId, visits, file_dir='.', fits_file=None):
        ...
        #ENK 6-28-2023: allow for fiberFlux instead of fiberMag to accommodate EDR1
        if 'fiberFlux' in hdu[self.hdu_dict['phot']].data.columns.names:
            mags = hdu[self.hdu_dict['phot']].data['fiberFlux']
        else:
